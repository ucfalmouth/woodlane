...
function theme_woodlane_get_custom_footer() {
    $footeritems = array(
        ...
        '<a href="http://dl.falmouth.ac.uk" class="nav-link edtech">Digital Learning</a>',
        ...
        '<a href="https://www.falmouth.ac.uk/falmouth-learning-space-accessibility-statement" class="nav-link portal">Accessibility</a>'
    );
    return $footeritems;
}
